...
class TrainingPipelineConfig:
    def __init__(self,timestamp=datetime.now()):
        ...
        self.artifact_name=training_pipeline.ARTIFACT_DIR  # These 2 parameters PIPELINE_NAME and ARTIFACT_DIR are being referred from the network security\constant\training pipeline\__init__.py
...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_ingestion_dir:str=os.path.join(training_pipeline_config.artifact_dir,training_pipeline.DATA_INGESTION_DATABASE_NAME)
